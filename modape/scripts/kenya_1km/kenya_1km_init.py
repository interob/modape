...
# year by year.
#
# Usage: python3 scripts/kenia_1km.py -b 2002-07-03 -e 2018-12-31
...
def slicename(dte):
    return str(Dekad(fromjulian(dte)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--end-date', help='End date (YYYY-MM-DD) for initialization',
                        default='2018-12-31', metavar='')
    args = parser.parse_args()

    this_dir, _ = os.path.split(__file__)
    with open(os.path.join(this_dir, 'kenia_1km.json')) as f:
    ...
    while begin_date < end_date:
        ...
        download_params['tile_filter'] = [
          'h21v08', 'h22v08', 'h21v09', 'h22v09'
        ]
